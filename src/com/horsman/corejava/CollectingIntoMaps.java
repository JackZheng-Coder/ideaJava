...
public class CollectingIntoMaps {
    ...
    public static Stream<Person> people(){
        return Stream.of(new Person(1001,"Peter"),new Person(1002,"Pual"),new Person(1003,"Mary"));
    }

    public static void main(String[] args) throws Exception {
        Map<Integer,String> idToName = people().collect(Collectors.toMap(Person::getId,Person::getName));
        System.out.println("idToNmae"+idToName);
        ...
        Map<String,String> languageName = locales.collect(Collectors.toMap(Locale::getDisplayLanguage,l->l.getDisplayLanguage(l),(existingValue,newValue)->existingValue));
